...
class $AssetsImgIconsGen {
  ...
  /// File path: assets/img/icons/ArticlesSelected.png
  ...
  /// File path: assets/img/icons/HomeSelected.png
  AssetGenImage get homeSelected =>
      const AssetGenImage('assets/img/icons/HomeSelected.png');
  ...
  /// File path: assets/img/icons/MenuSelected.png
  AssetGenImage get menuSelected =>
      const AssetGenImage('assets/img/icons/MenuSelected.png');
